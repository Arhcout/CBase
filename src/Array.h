...
#define ArrayPushI(arr, data)                                                  \
  {                                                                            \
    typeof(data) x = data;                                                     \
    (arr) = ManualArrayPushBulk((arr), &x, 1);                                 \
  }                                                                            \
  (void)0
#define ArrayPush(arr, data)                                                   \
  {                                                                            \
    (arr) = ManualArrayPushBulk((arr), (data), 1);                             \
  }                                                                            \
  (void)0
#define ArrayPushBulk(arr, data, len)                                          \
  arr = ManualArrayPushBulk((arr), (data), (len))
